            ...
            else
            {
                ...
                foreach (var  property in propertys)
                {
                    ...
                    if (property.PropertyType.IsValueType || property.PropertyType == typeof(string))
                    {
                        ...
                        if (value != null)
                        {
                            property.SetValue(obj, Convert.ChangeType(value.AttemptedValue, property.PropertyType));
                        }
                    }  //引用类型的绑定
                    else
                    {
                        ...
                        foreach (var item in sonTypePropertys)
                        {
                            ...
                            else if (item.PropertyType.IsValueType || item.PropertyType == typeof(string))
                            {
                                ...
                                if (value != null)
                                {
                                    item.SetValue(sonOBJ, Convert.ChangeType(value.AttemptedValue, item.PropertyType));
                                }
                            }
                            else
                            {
